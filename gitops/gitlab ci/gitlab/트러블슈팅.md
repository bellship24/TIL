...
### 1.3.1. 80,443 이 열려있는 내부 IP 찾기

10.0.0.[232, 249]

### 1.3.2. helm 으로 metallb 설치 및 VIP range 설정 변경
...
### 1.3.4. ingress-nginx-controller 의 external IP 를 변경한 VIP 로 수정
...
### 1.3.5. gitlab helm release 의 override-values.yaml 을 upgrade
